...
# input saved on s3 https://eu-central-1.linodeobjects.com/gisat-data/3DFlus_GST-22/app-gisat-deckglSandbox/vectors/SO_Praha_Neratovice%2Bh-z-geoportalu%2Bcl_risk_4326.geojson
