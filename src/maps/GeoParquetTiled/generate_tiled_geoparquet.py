...
try:
    ...
    # 🛑 The DuckDB execute method handles running the multi-line SQL 🛑
    con.execute(copy_sql)
    print(f"🎉 SUCCESS: Tiled dataset generated by DuckDB native COPY to: {OUTPUT_TILED_GEOPARQUET_DIR}")
